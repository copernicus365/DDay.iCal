...
namespace DDay.iCal.Simple.TZ
{
	...
	internal class TimeZonesGenerator
	{
		...
		public static void GetValuesFromOnline(
			out KeyValues[] windowsTimeZones,
			...
			out KeyValuePair<string, string>[] tzTimeZones)
		{
			...
			var kvs = new List<KeyValues>(len + 50);
			string tzid = null;
			string winId = null;
			char[] spaceSeperator = { ' ' };
		...
		public static string ValuesToPersistString(KeyValues[] windowsTimeZones)
		{
		...
		public static KeyValues[] ReadTimeZonesPersistStringToWindowsTimeZones(string timeZonesPersistString)
		{
			...
			var kvs = new List<KeyValues>(100);
			var vals = new List<string>(20);
			var currKv = new KeyValues();
			...
			for (int i = 0; i < count; i++) {
				...
				currKv = new KeyValues() { Key = winTz };
				kvs.Add(currKv);
		...
		public static KeyValuePair<string, string>[] GetTZTimeZonesFromWinZones(KeyValues[] windowsTimeZones)
		{
		...
		public static Dictionary<string, string> GetTZTimeZonesDictionaryFromWinZones(KeyValues[] windowsTimeZones)
		{
			var tzDict = new Dictionary<string, string>(440);
		...
		public static Dictionary<string, KeyValues> GetWindowsTimeZonesDictionary(KeyValues[] windowsTimeZones)
		{
			var tzDict = new Dictionary<string, KeyValues>(100);
		...
		public static void GetDictionaries(
			out Dictionary<string, KeyValues> winDict,
